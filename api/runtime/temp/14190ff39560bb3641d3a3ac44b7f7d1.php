<?php /*a:1:{s:68:"/www/wwwroot/testskl.ruhuashop.com/app/view/install/index/step2.html";i:1637292242;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>多门店剧本杀系统</title>
...
<div style="width:800px;margin: 100px auto;">
    <div class="layui-layout layui-layout-admin">
        <div class="blue head-box">
            多门店剧本杀安装引导--v<?php echo VAE_VERSION; ?>
        </div>
        <div style="border:1px solid #eee;padding:20px;line-height: 25px;">
            ...
            <table class="layui-table" lay-skin="nob" lay-size="sm">
                ...
                <tr>
                    ...
                    <td><i class="layui-icon <?php if($data['session'] == '1'): ?>layui-icon-ok yes<?php else: ?>layui-icon-close<?php endif; ?>"></i></td>
                </tr>
                <tr>
                    <td>PDO</td>
                    <td>开启</td>
                    <td><?php if($data['pdo'] == '1'): ?>已开启<?php else: ?>未开启<?php endif; ?></td>
                    <td><i class="layui-icon <?php if($data['pdo'] == '1'): ?>layui-icon-ok yes<?php else: ?>layui-icon-close<?php endif; ?>"></i></td>
                </tr>
                <tr>
                    <td>PDO_Mysql</td>
                    <td>开启</td>
                ...
                <tr>
                    ...
                    <td><i class="layui-icon <?php if($data['upload_size'] == '0'): ?>layui-icon-close<?php else: ?>layui-icon-ok yes<?php endif; ?>"></i></td>
                </tr>
                </tbody>
            </table>
            <h3>目录权限</h3>
            <table class="layui-table" lay-skin="nob" lay-size="sm">
                ...
                <tr>
                    ...
                    <td>可写</td>
                    <td>
                        <?php if (is_writable(VAE_ROOT . 'data')): ?>
                        可写
                        <?php else: ?>
                        不可写
                        <?php endif ?>
                    </td>
                    <td class="<?php if(is_writable(VAE_ROOT . 'data'))echo 'yes'; ?>">
                        <?php if (is_writable(VAE_ROOT . 'data')): ?>
                        <i class="layui-icon layui-icon-ok"></i>
                        <?php else: ?>
                        <i class="layui-icon layui-icon-close"></i>
            ...
            <div style="margin:10px auto;width: 190px;">
                <a href="<?php echo url('install'); ?>" class="layui-btn  blue">上一步</a>
    ...
    layui.use(['jquery','layer'], function(){
        ...
        $('#step2').click(function(){
            if($('.yes').length!=8){
                ...
                location.href="<?php echo url('install/step3'); ?>";
            }
        })
