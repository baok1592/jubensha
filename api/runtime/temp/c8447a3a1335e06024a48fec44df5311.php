<?php /*a:1:{s:68:"/www/wwwroot/testskl.ruhuashop.com/app/view/install/index/step3.html";i:1637292242;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div style="border:1px solid #eee;padding:20px;line-height: 25px;">
            ...
            <form class="layui-form" action="" id="form">
                ...
                <div class="layui-form-item">
                    <div style="margin:10px auto;width: 190px;">
                        <a href="<?php echo url('install/step2'); ?>" class="layui-btn" style="background: #C0C0C0">上一步</a>
            ...
            <div style="display: none;text-align: center;" id="complete">
                <h1>安装完成!</h1><br><br><br>
                <p>手机端访问地址：<?php echo htmlentities($_SERVER['HTTP_HOST']); ?>/h5/index.html</p>
...
<script>
    layui.use(['element', 'jquery', 'layer', 'form'], function () {
        ...
        form.on('submit(formDemo)', function (data) {
            ...
            $.ajax({
                url: "<?php echo url('install/create_data'); ?>",
                type: "post",
                data: data.field,
                beforeSend: function () {
                    // 禁用按钮防止重复提交
