...
class Index extends BaseController
{
    ...
    public function createData()
    {
        ...
        if ($this->request->isPost()) {
            ...
            // 导入sql数据并创建表
            $vaethink_sql = file_get_contents(VAE_ROOT . '/data/script.sql');
            ...
            $create_time = time();
            $caeate_admin_sql="INSERT INTO" . "`".$data['DB_PREFIX'] . "admin"."`(id,username,password) values(1,'{$username}','{$password}') ";
